    ...
    <div className="p-8 max-w-6xl">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">Create, manage, and export client invoices</p>
        </div>
        <Link
        ...
        {invoices.length === 0 ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-sky-900/20 text-left text-muted-foreground">
              ...
              <tbody>
                {invoices.map((inv) => (
                  <tr key={inv.id} className="border-b border-sky-900/10 hover:bg-slate-800/20">
                    ...
                    <td className="px-5 py-3 text-foreground/80">{inv.clientName || "—"}</td>
                    ...
                    <td className="px-5 py-3">
                      <div className="flex items-center justify-end gap-1">
                        ...
                        <button
                          ...
                          className="p-2 rounded-lg text-muted-foreground hover:text-red-400 hover:bg-red-950/30"
                          title="Delete"
                        >
