...
export const STATIC_PAGES = [
  ...
  },
  {
    ...
    body: `<main><h1>Contact Adrevnview</h1><p data-geo-chunk="summary">Tell us about your web design, development, SEO, or branding project. Our team responds within one business day with next steps and a tailored proposal.</p><p>Email: <a href="mailto:hello@adrevnview.com">hello@adrevnview.com</a><br>Phone: <a href="tel:5125550147">(512) 555-0147</a><br>Address: 1200 Innovation Blvd, Suite 400, Austin, TX 78701</p><h2>Request a quote</h2><p>Share your goals, timeline, and budget range. We serve B2B SaaS, eCommerce, healthcare, legal, real estate, manufacturing, and financial services organizations.</p><p>Try our free <a href="/geo-report">SEO &amp; GEO Report</a> to analyze any URL for search and AI visibility.</p></main>`,
  },
  {
    path: "/privacy",
